...
for m_len = 12:12   % The end of loop body is at the end of this file
    % factorize  N 
...
RAM_0 = zeros(ceil(N_max/NumOfBanks),NumOfBanks);  % 5 banks
RAM_1 = zeros(ceil(N_max/NumOfBanks),NumOfBanks);  % 5 banks
current_RAM = 0;
RAM_read = zeros(ceil(N_max/NumOfBanks),NumOfBanks);  % 5 banks
RAM_write = zeros(ceil(N_max/NumOfBanks),NumOfBanks);  % 5 banks
...
for t=0:N-1
    ...
    RAM_0( addr_in_bank +1, switch_bank +1 ) = x_PFAmap(t +1);
