...
# # End of template
# ----------------------------------------
# If lpm_mult_16_mrd is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 185 win32 2017.04.17.11:52:38
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "lpm_mult_16_mrd"
}
...
ensure_lib                              ./libraries/lpm_mult_16_mrd_lpm_mult_151/
vmap       lpm_mult_16_mrd_lpm_mult_151 ./libraries/lpm_mult_16_mrd_lpm_mult_151/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../lpm_mult_151/sim/lpm_mult_16_mrd_lpm_mult_151_lx6omxy.v" -work lpm_mult_16_mrd_lpm_mult_151
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/lpm_mult_16_mrd.v"                                                                            
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L lpm_mult_16_mrd_lpm_mult_151 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L lpm_mult_16_mrd_lpm_mult_151 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
