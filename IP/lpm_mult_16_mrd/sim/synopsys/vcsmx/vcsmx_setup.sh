...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../lpm_mult_151/sim/lpm_mult_16_mrd_lpm_mult_151_lx6omxy.v" -work lpm_mult_16_mrd_lpm_mult_151
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/lpm_mult_16_mrd.v"                                                                            
fi
