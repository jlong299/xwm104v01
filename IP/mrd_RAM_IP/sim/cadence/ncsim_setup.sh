...
# ACDS 15.1 193 win32 2017.02.27.15:34:12
...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="C:/altera_pro/15.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../ram_2port_151/sim/mrd_RAM_IP_ram_2port_151_zwzljpy.v" -work ram_2port_151 -cdslib ./cds_libs/ram_2port_151.cds.lib
