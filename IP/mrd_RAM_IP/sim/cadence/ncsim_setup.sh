...
mkdir -p ./libraries/mrd_RAM_IP_ram_2port_151/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../ram_2port_151/sim/mrd_RAM_IP_ram_2port_151_hwholfq.v" -work mrd_RAM_IP_ram_2port_151 -cdslib ./cds_libs/mrd_RAM_IP_ram_2port_151.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/mrd_RAM_IP.v"                                                                                                                              
fi
