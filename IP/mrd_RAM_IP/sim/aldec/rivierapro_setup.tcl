...
# ACDS 15.1 185 win32 2017.04.18.11:04:31
# ----------------------------------------
...
ensure_lib                          ./libraries/mrd_RAM_IP_ram_2port_151
vmap       mrd_RAM_IP_ram_2port_151 ./libraries/mrd_RAM_IP_ram_2port_151
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../ram_2port_151/sim/mrd_RAM_IP_ram_2port_151_hwholfq.v" -work mrd_RAM_IP_ram_2port_151
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/mrd_RAM_IP.v"                                                                          
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L mrd_RAM_IP_ram_2port_151 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L mrd_RAM_IP_ram_2port_151 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
