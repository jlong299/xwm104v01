...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_151/sim/ff_rdx_data_fifo_151_vbtzbya.v" -work ff_rdx_data_fifo_151 -cdslib ./cds_libs/ff_rdx_data_fifo_151.cds.lib
