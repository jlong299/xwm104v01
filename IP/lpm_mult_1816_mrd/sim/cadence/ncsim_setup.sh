...
TOP_LEVEL_NAME="lpm_mult_1816_mrd"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/lpm_mult_1816_mrd_lpm_mult_151/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../lpm_mult_151/sim/lpm_mult_1816_mrd_lpm_mult_151_lsm6l5i.v" -work lpm_mult_1816_mrd_lpm_mult_151 -cdslib ./cds_libs/lpm_mult_1816_mrd_lpm_mult_151.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/lpm_mult_1816_mrd.v"                                                                                                                                        
fi
