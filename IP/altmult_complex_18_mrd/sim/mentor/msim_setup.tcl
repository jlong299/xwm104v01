...
# # End of template
# ----------------------------------------
# If altmult_complex_18_mrd is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 185 win32 2017.04.17.15:33:21
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "altmult_complex_18_mrd"
}
...
ensure_lib                                            ./libraries/altmult_complex_18_mrd_altmult_complex_151/
vmap       altmult_complex_18_mrd_altmult_complex_151 ./libraries/altmult_complex_18_mrd_altmult_complex_151/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altmult_complex_151/sim/altmult_complex_18_mrd_altmult_complex_151_id3q2ma.v" -work altmult_complex_18_mrd_altmult_complex_151
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altmult_complex_18_mrd.v"                                                                                                        
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altmult_complex_18_mrd_altmult_complex_151 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altmult_complex_18_mrd_altmult_complex_151 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
