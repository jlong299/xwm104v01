...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altmult_complex_151/sim/altmult_complex_18_mrd_altmult_complex_151_id3q2ma.v" -work altmult_complex_18_mrd_altmult_complex_151
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altmult_complex_18_mrd.v"                                                                                                        
fi
