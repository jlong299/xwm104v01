...
TOP_LEVEL_NAME="altmult_complex_18_mrd"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/altmult_complex_18_mrd_altmult_complex_151/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../altmult_complex_151/sim/altmult_complex_18_mrd_altmult_complex_151_id3q2ma.v" -work altmult_complex_18_mrd_altmult_complex_151 -cdslib ./cds_libs/altmult_complex_18_mrd_altmult_complex_151.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altmult_complex_18_mrd.v"                                                                                                                                                                              
fi
