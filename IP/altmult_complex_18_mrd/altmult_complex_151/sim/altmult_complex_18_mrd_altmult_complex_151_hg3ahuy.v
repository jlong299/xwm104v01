//altmult_complex CBX_AUTO_BLACKBOX="ALL" CBX_SINGLE_OUTPUT_FILE="ON" DEVICE_FAMILY="Arria 10" IMPLEMENTATION_STYLE="AUTO" PIPELINE=2 REPRESENTATION_A="SIGNED" REPRESENTATION_B="SIGNED" WIDTH_A=18 WIDTH_B=18 WIDTH_RESULT=36 clock dataa_imag dataa_real datab_imag datab_real result_imag result_real
...
module  altmult_complex_18_mrd_altmult_complex_151_hg3ahuy
	( 
	clock,
	dataa_imag,
	dataa_real,
...
`endif
	...
	// synopsys translate_on
	always @(posedge clock)
		result_real_output_reg <= result_real_wire[35:0];
	// synopsys translate_off
	initial
		result_imag_output_reg = 0;
	// synopsys translate_on
	always @(posedge clock)
		result_imag_output_reg <= result_imag_wire[35:0];
...
endmodule //altmult_complex_18_mrd_altmult_complex_151_hg3ahuy
//VALID FILE
