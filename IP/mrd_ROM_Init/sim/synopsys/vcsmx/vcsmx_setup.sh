...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../rom_1port_151/sim/mrd_ROM_Init_rom_1port_151_qacsi6a.v" -work mrd_ROM_Init_rom_1port_151
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/mrd_ROM_Init.v"                                                                            
fi
