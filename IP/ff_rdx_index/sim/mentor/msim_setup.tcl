...
# # End of template
# ----------------------------------------
# If ff_rdx_index is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 185 win32 2017.03.12.11:58:27
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "ff_rdx_index"
}
...
ensure_lib                       ./libraries/ff_rdx_index_fifo_151/
vmap       ff_rdx_index_fifo_151 ./libraries/ff_rdx_index_fifo_151/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../fifo_151/sim/ff_rdx_index_fifo_151_dv6wpvq.v" -work ff_rdx_index_fifo_151
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ff_rdx_index.v"                                                             
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L ff_rdx_index_fifo_151 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L ff_rdx_index_fifo_151 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
