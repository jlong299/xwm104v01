...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ram_2port_151/sim/mrd_RAM_IP_ram_2port_151_zwzljpy.v" -work ram_2port_151
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/sim/mrd_RAM_IP.v"                                                               
}
